...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,700;1,800&display=swap');
...
<nav class="bg-white shadow-md px-6 lg:px-16 py-4 flex items-center justify-between sticky top-0 z-50 border-b border-slate-100">
    ...
    <div class="hidden md:flex items-center space-x-8" id="nav-links">
        ...
        <a href="#profil" class="nav-link text-sm font-semibold text-slate-500 pb-1 transition-colors" data-section="profil">Profil</a>
        <a href="#jadwal" class="nav-link text-sm font-semibold text-slate-500 pb-1 transition-colors" data-section="jadwal">Jadwal</a>
        <a href="#informasi" class="nav-link text-sm font-semibold text-slate-500 pb-1 transition-colors" data-section="informasi">Informasi</a>
        <a href="#kontak" class="nav-link text-sm font-semibold text-slate-500 pb-1 transition-colors" data-section="kontak">Kontak</a>
    </div>
...
<!-- Profil Section -->
<section id="profil" class="pt-16 lg:pt-24 pb-20 bg-white relative border-t border-slate-100">
    <!-- Decorative Pattern Background (optional subtle pattern) -->
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-16 relative z-10">
        
        <!-- Content Wrapper -->
        <div class="flex flex-col lg:flex-row gap-16 items-center" data-aos="fade-up">
            <!-- Left: Image -->
            <div class="lg:w-1/2 w-full">
                <div class="overflow-hidden aspect-[4/3] lg:aspect-auto lg:h-[500px] w-full relative group rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <div class="absolute inset-0 ring-1 ring-inset ring-slate-900/5 pointer-events-none rounded-2xl"></div>
                </div>
            </div>
            ...
            <div class="lg:w-1/2 w-full">
                <div class="flex items-center gap-3 mb-3">
                    <span class="text-emerald-600 text-[12px] font-black uppercase tracking-[0.2em]">Profil Madrasah</span>
                </div>
                <h2 class="text-3xl lg:text-4xl font-black text-slate-800 uppercase tracking-tight mb-5 leading-tight">MI Nurul Ikhlas<br>Al-Ayubi</h2>
                <p class="text-slate-500 font-medium leading-relaxed mb-10 text-sm lg:text-base">
                    Madrasah Ibtidaiyah yang berkomitmen membentuk generasi Qur'ani, berakhlak mulia, cerdas, dan berwawasan global melalui pendidikan berbasis nilai-nilai Islam dan perkembangan zaman.
                </p>
                
                <!-- Stats Row -->
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x md:divide-slate-200">
                    <div class="text-center px-3">
                        <div class="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3 text-lg"><i class="fas fa-users"></i></div>
                        <h4 class="text-2xl font-black text-slate-800"><?= htmlspecialchars($data['stats_siswa'] ?? '250+') ?></h4>
                        <p class="text-xs font-bold text-slate-700 mt-1">Siswa</p>
                        <p class="text-[10px] font-medium text-slate-500 mt-0.5">Siswa Aktif</p>
                    </div>
                    <div class="text-center px-3">
                        <div class="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3 text-lg"><i class="fas fa-user-graduate"></i></div>
                        <h4 class="text-2xl font-black text-slate-800"><?= htmlspecialchars($data['stats_guru'] ?? '15+') ?></h4>
                        <p class="text-xs font-bold text-slate-700 mt-1">Guru</p>
                        <p class="text-[10px] font-medium text-slate-500 mt-0.5">Tenaga Pendidik</p>
                    </div>
                    <div class="text-center px-3">
                        <div class="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3 text-lg"><i class="fas fa-trophy"></i></div>
                        <h4 class="text-2xl font-black text-slate-800"><?= htmlspecialchars($data['stats_eskul'] ?? '8+') ?></h4>
                        <p class="text-xs font-bold text-slate-700 mt-1">Eskul</p>
                        <p class="text-[10px] font-medium text-slate-500 mt-0.5">Kegiatan Unggulan</p>
                    </div>
                    <div class="text-center px-3">
                        <div class="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3 text-lg"><i class="fas fa-calendar-check"></i></div>
                        <p class="text-[10px] font-bold text-slate-600 mb-0.5">Akreditasi</p>
                        <h4 class="text-2xl font-black text-slate-800"><?= htmlspecialchars($data['stats_akreditasi'] ?? 'BAIK') ?></h4>
                        <p class="text-[10px] font-medium text-slate-500 mt-1">Oleh BAN-S/M</p>
                    </div>
                </div>
            </div>
        </div>
...
<section id="informasi" class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-6 lg:px-16">
        ...
        <div class="text-center bg-slate-50 rounded-2xl p-10 border border-slate-200">
            ...
            <p class="text-slate-500 font-medium mb-6 max-w-md mx-auto">Kuota terbatas untuk Gelombang 1. Pastikan Anda mengamankan kursi putra-putri Anda sekarang juga.</p>
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up" data-aos-delay="100">
            <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm text-center hover:shadow-md transition-shadow">
                ...
                <p class="text-sm text-slate-500 font-medium">Jl. Raya Pagedangan - Legok<br>RT 001/003 Desa Jatake, Kec. Pagedangan</p>
            </div>
            <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm text-center hover:shadow-md transition-shadow">
                ...
                <p class="text-sm text-slate-500 font-medium">(021) 1234-5678<br>0812-3456-7890</p>
            </div>
            <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm text-center hover:shadow-md transition-shadow">
                ...
                <p class="text-sm text-slate-500 font-medium">info@misnurulikhlas.sch.id<br>ppdb@misnurulikhlas.sch.id</p>
            </div>
        </div>
    </div>
</section>
...
function updateActiveNav() {
  ...
  navLinks.forEach(link => {
    ...
    if (section === current) {
      ...
      link.className = 'nav-link text-sm font-semibold text-slate-500 pb-1 transition-colors hover:text-emerald-700';
    }
  });
}
