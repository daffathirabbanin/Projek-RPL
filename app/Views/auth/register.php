    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 relative h-full bg-white overflow-y-auto">
        <div class="w-full max-w-[420px] py-8 lg:py-0">
            ...
            <div class="text-center lg:text-left mb-6">
                ...
                <h2 class="text-3xl font-black text-slate-800 uppercase tracking-tight mb-2">Buat Akun</h2>
                <p class="text-slate-500 font-medium text-sm">Lengkapi data di bawah ini untuk mendaftar.</p>
            </div>
            ...
            <form action="<?= base_url('auth/register_process') ?>" method="POST" class="space-y-4">
                <!-- Nama Lengkap -->
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] mb-1.5">Nama Lengkap</label>
                    <div class="relative group">
                        ...
                        <input type="text" name="name" class="block w-full pl-10 pr-4 py-3 border-2 border-slate-200/80 rounded-lg text-sm text-slate-800 placeholder-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-0 focus:border-emerald-500 transition-all shadow-sm" placeholder="Nama Lengkap Anak" required>
                    </div>
                </div>

                <!-- Email -->
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] mb-1.5">Alamat Email</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors group-focus-within:text-emerald-600 text-slate-400">
                            <i class="fas fa-envelope text-sm"></i>
                        </div>
                        <input type="email" name="email" class="block w-full pl-10 pr-4 py-3 border-2 border-slate-200/80 rounded-lg text-sm text-slate-800 placeholder-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-0 focus:border-emerald-500 transition-all shadow-sm" placeholder="Masukkan Alamat Email" required>
                    </div>
                </div>

                <!-- Password -->
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] mb-1.5">Password</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors group-focus-within:text-emerald-600 text-slate-400">
                            <i class="fas fa-lock text-sm"></i>
                        </div>
                        <input type="password" id="password" name="password" minlength="6" class="block w-full pl-10 pr-4 py-3 border-2 border-slate-200/80 rounded-lg text-sm text-slate-800 placeholder-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-0 focus:border-emerald-500 transition-all shadow-sm" placeholder="Buat Password (Min. 6 Karakter)" required>
                    </div>
                </div>

                <!-- Konfirmasi Password -->
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] mb-1.5">Konfirmasi Password</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors group-focus-within:text-emerald-600 text-slate-400">
                            <i class="fas fa-lock text-sm"></i>
                        </div>
                        <input type="password" id="password_confirm" name="password_confirm" minlength="6" class="block w-full pl-10 pr-4 py-3 border-2 border-slate-200/80 rounded-lg text-sm text-slate-800 placeholder-slate-400 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-0 focus:border-emerald-500 transition-all shadow-sm" placeholder="Masukkan Ulang Password" required>
                    </div>
                </div>
